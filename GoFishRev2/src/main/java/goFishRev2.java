...
abstract class Player
{
    ...
    protected boolean askFor(Card cType)
    {
        ...
        if (this instanceof HumanPlayer)
            tmp = 1;
        Player other = goFishRev2.Players[tmp];
    ...
    protected void fish()
    {
        if (goFishRev2.deckSize() > 0)
            hand.add(goFishRev2.draw());
        else
...
class AIPlayer extends Player
{
    ...
    private Card aiMagic()
    {
        ...
        return hand.get(goFishRev2.rng.nextInt(hand.size()));
    }
}