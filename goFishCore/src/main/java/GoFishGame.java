        ...
        public void checkBeginningDeal(){
            ...
            if(userBegDeal != 0){
                ...
                + "on the deal of the value " + userBegDeal +
                        "\nThat puts you at one Book already!");
                pause();
                userBooks++;
            }
            ...
            do {
                ...
                if(!win){
                    ...
                    while(userHand.getCount(value) == 0){
                        System.out.println("That value isn't already contained in your deck, please enter another value: ");
                        value = input.nextInt();
                    }
            ...
            public void cpuTurn(){
                ...
                do{
                    ...
                    if(!win){
                        ...
                        Card random = cpHand.deleteAnyCard();
                    ...
                    public void checkForGameOver(){
                        win = (stock.getSize() == 0 || userHand.getSize() == 0 || cpHand.getSize() == 0);
                    }
