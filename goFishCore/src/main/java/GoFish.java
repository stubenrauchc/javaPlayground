        ...
        do {
            ...
            switch (menue) {
                case 1 -> {
                    ...
                    suit = input.nextInt();
                    System.out.println("Now enter the value of the card as a number (1-13): ");
                    value = input.nextInt();
                ...
                case 5 -> System.out.println("Total number of cards in Deck: " + deck.getSize());
                case 6 -> System.out.println(deck);
                case 7 -> {repDeckTest = false;
                return true;}
                case 8 -> {repDeckTest = false;
                return false;}
            }
        }
        while (repDeckTest);
